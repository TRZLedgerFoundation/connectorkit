...
import { useSwap } from '@connectorkit/solana'
...
```tsx
import { createJupiter, createProviders } from '@arc/providers'
...
See the [provider template](https://github.com/your-org/arc/blob/main/packages/providers/src/templates/provider-template.md) for a complete step-by-step guide to adding new providers to the `@arc/providers` package.
