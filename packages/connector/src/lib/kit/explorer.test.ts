...
describe('Explorer Utilities', () => {
    describe('getExplorerLink', () => {
        ...
        it('should return base URL with no arguments', () => {
            ...
            expect(url).toBe('https://explorer.trezoa.com/');
        });
    });
});
